...
<html>
    <head>
        ...
        <title>Login Supervisor Externo | TSE </title>
        <!-- Favicon-->
                ...
                <div class="body" >
                    <form id="sign_in" method="post" action="../../SerSesionSupervisor">                 
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" class="form-control" name="txtUser" placeholder="Ingrese su número de identificación" required autofocus>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
