...
<html>
    ...
    <head>
        ...
        <title>Error Servidor | TSE </title>
        <!-- Favicon-->
        ...
        <script>
            $(document).on("ready", function () {
                ...
                $("#btnRegresar").on("click", function () {
                   ...
                   alert("Lo sentimos en estos momentos estamos reparando el error");
    ...
    <body class="four-zero-four">
        <div class="four-zero-four-container">
            ...
            <div class="error-message">Por el momento algo ocurrio con nuestro servidor, intenta acceder al sition en unos minutos</div>
