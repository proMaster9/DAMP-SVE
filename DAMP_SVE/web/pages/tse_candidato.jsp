    ...
    <head>
        ...
        <script>
            $(document).on("ready", function () {
                //limpiar contenedor de la imagen
                $("#btnLimpiar").on("click", function () {
                    $("#divImg").html("Vista Previa");
                });
                ...
                $("#btnModificar").on("click", function () {
                    ...
                    if (modificar != 0) {
                        $("#btnModificarG").on("click", function () {
                            $("#frmCandidato").submit();
                        });
                    } else {
                ...
                $("#btnEliminar").on("click", function () {
                    var idCandidato = $("#txtIdCandidatoE").val();
                    alert("sdsd" + idCandidato);
                    $.post('../SerCandidato', {
                        btnEliminar: true,
                        idCandidato: idCandidato
                    }, function (data) {
                        $("#divCandidato").html(data);
                    });
            ...
            function eliminar(idCandidato) {
                $("#txtIdCandidatoE").val(idCandidato);
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-6">
                                        <div class="form-group">
                                            <select class="form-control show-tick" data-live-search="true" name="slPartido" id="slPartido">
                                                <option>Seleccione partido</option>
                                                <%
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-9 col-xs-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                ...
                                                <input type="text" name="txtDui" id="txtDui" autocomplete="off" class="form-control" placeholder="Ingresar numero de DUI">
                                            </div>
                                        </div>
                                    </div>
                                </div>
